...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            ['name' => 'Creator Support', 'description' => 'Support for content creators and artists', 'color' => '#D53F8C', 'icon' => 'heart'],
            ...
            ['name' => 'Lifestyle & Delivery', 'description' => 'Food delivery and lifestyle services', 'color' => '#ECC94B', 'icon' => 'shopping-cart'],
